...
TEST(ChemGillespieTest, StoichiometryInvariants) {
    ...
    chemsim->setInstance(new ChemGillespieImpl());
...
TEST(ChemGillespieTest, SimpleSteadyState) {
    int Nstart = 16;
...
TEST(ChemGillespieTest, SimpleTransient) {
    ...
    // The results below are for N=10
    // (coming from both analytical formula and numerical integration)
